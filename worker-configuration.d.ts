/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 759cb54aa1de9dd16a27e0bca6f39ff9)
// Runtime types generated with workerd@1.20260212.0 2026-02-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./server/index");
		durableNamespaces: "ConnectionHub";
	}
	interface Env {
		DB: D1Database;
		ASSETS: Fetcher;
		CONNECTION_HUB: DurableObjectNamespace<import("./server/index").ConnectionHub>;
	}
}
